// $Id: CompetiWeb.cc 2500 2017-02-27 17:33:43Z axel $
#include <string>
const std::string version("$Revision: 2500 $");
const std::string source("$Source: /home/cvsrep/CVS/NewWeb/src/MoranI.cc,v $ $Date: 2017-02-27 17:33:43 +0000 (Mon, 27 Feb 2017) $");
