...
.LBB11:
	...
	movswq	(%rdx),%rcx
	movswq	2(%rdx),%r8
	movlpd	(%rdi,%rcx,8), %xmm1
	movswq	4(%rdx),%r9
	movlpd  (%rsi,%r8,8), %xmm2
	movswq	6(%rdx),%r10
	movhpd	(%rdi,%r9,8), %xmm1
	movswq	8(%rdx),%rcx
	movhpd  (%rsi,%r10,8), %xmm2
	movswq	0xa(%rdx),%r8
//
 	mulpd 	%xmm1,%xmm2
	movlpd	(%rdi,%rcx,8), %xmm4
	movswq	0xc(%rdx),%r9
	movlpd  (%rsi,%r8,8), %xmm5
	movswq	0xe(%rdx),%r10
//
	mulpd 	32(%rdx), %xmm2
	movhpd	(%rdi,%r9,8), %xmm4
	movswq	0x10(%rdx),%rcx
	movhpd  (%rsi,%r10,8), %xmm5
...
//
	mulpd 	%xmm4,%xmm5
	movlpd	(%rdi,%rcx,8), %xmm6
	movswq	0x14(%rdx),%r9
	movlpd  (%rsi,%r8,8), %xmm7
	movswq	0x16(%rdx),%r10
//
	mulpd 	48(%rdx), %xmm5
	movhpd	(%rdi,%r9,8), %xmm6
	movswq	0x18(%rdx),%rcx
	movhpd  (%rsi,%r10,8), %xmm7
	movswq	0x1a(%rdx),%r8
//
	mulpd 	%xmm6,%xmm7
	movlpd	(%rdi,%rcx,8), %xmm1
