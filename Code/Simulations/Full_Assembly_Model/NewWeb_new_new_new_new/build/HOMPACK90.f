...
C Pached, to avoid complications from array descriptors:
C      REAL (KIND=R8), DIMENSION(:), INTENT(IN OUT)::A,Y
      REAL (KIND=R8), INTENT(IN OUT)::A(N),Y(N+1)
...
C
      ...
      LOGICAL, INTENT(IN OUT):: CRASH,START
      REAL (KIND=R8), INTENT(IN):: A(:),SSPAR(8)
      REAL (KIND=R8), INTENT(IN OUT):: ABSERR,H,HOLD,RELERR,
     &  Y(:),YOLD(:),YP(:),YPOLD(:)
      REAL (KIND=R8):: S
      REAL (KIND=R8), INTENT(OUT), DIMENSION(:):: TZ,W,WP,Z0,Z1
C
...
C
      ...
      REAL (KIND=R8), INTENT(IN OUT):: HOLD,H,RELERR,ABSERR,RHOLEN,
     &  SSPAR(8)
      REAL (KIND=R8):: S
      REAL (KIND=R8), DIMENSION(:), INTENT(IN):: A
      REAL (KIND=R8), DIMENSION(:), INTENT(IN OUT):: Y,YP,YOLD,YPOLD,
...
C
      ...
      LOGICAL, INTENT(IN OUT):: CRASH,START
      REAL (KIND=R8), INTENT(IN):: A(:),SSPAR(4)
      REAL (KIND=R8), INTENT(IN OUT):: ABSERR,H,HOLD,RELERR,WK,
     &    Y(:),YOLD(:),YP(:),YPOLD(:)
      REAL (KIND=R8):: S
      REAL (KIND=R8), INTENT(OUT), DIMENSION(:):: DZ,T,Z0
C
