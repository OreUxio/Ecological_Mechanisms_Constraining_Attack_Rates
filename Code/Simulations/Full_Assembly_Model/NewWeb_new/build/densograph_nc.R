#$Id: densograph_nc.R 849 2007-01-19 07:45:45Z cvsrep $
library(KernSmooth)
library(lattice)
...
grid <- expand.grid(x=estL1$x1, y=estL1$x2,kinds=c("producers", "herbivores") )
...
postscript(file="densograph_nc.ps", horizontal = FALSE,
