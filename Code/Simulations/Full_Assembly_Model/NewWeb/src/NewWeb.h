// -*- mode: c++ -*-
// $Id: NewWeb.h 2472 2016-05-21 18:11:21Z axel $
#ifndef _NEWWEB_H_
#define _NEWWEB_H_
...
public:
#define ONLY_FIT_DECLARE(X) NewSpecies * X##_only_fit(double plant_fraction)
  ONLY_FIT_DECLARE(invade);
  ONLY_FIT_DECLARE(speciate_selected);
  ONLY_FIT_DECLARE(speciate);
  ONLY_FIT_DECLARE(invade_or_speciate);
  ONLY_FIT_DECLARE(invade_or_speciate_any);
  ONLY_FIT_DECLARE(invade_or_speciate_any_by_biomass);
#undef ONLY_FIT_DECLARE
//   /// This macro iterates attempted additions until a species with
//   /// positive invasion fitness is found.
